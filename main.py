...
ffmpeg_command = """ffmpeg -f dshow -i video="@device_pnp_\\\\?\\usb#vid_01da&pid_5875&mi_00#6&770fab3&0&0000#{65e8773d-8f56-11d0-a3b9-00a0c9223196}\\global" -c:v libx264 -preset medium -f flv rtmp://server.dsttamal.me:1935/stream1"""
